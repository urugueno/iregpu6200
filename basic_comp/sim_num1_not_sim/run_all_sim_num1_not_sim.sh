...
bash ./basic_comp/sim_num1_not_sim/sim_EE.sh > ./basic_comp/sim_num1_not_sim/sim_EE_ver2.txt
echo "=== [1/4] done ==="

echo "=== [2/4] sim_EQ.sh (env=EQ) ==="
bash ./basic_comp/sim_num1_not_sim/sim_EQ.sh > ./basic_comp/sim_num1_not_sim/sim_EQ_ver2.txt
echo "=== [2/4] done ==="

echo "=== [3/4] sim_PE_query.sh (env=PE_query) ==="
bash ./basic_comp/sim_num1_not_sim/sim_PE_query.sh > ./basic_comp/sim_num1_not_sim/sim_PE_query_ver2.txt
echo "=== [3/4] done ==="
